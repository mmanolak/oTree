...
doc = "Treatment 2b: Probabilistic 'Chaos' Vote. This app uses a self-contained rotation engine."
...
class C(BaseConstants):
    ...
    # Not used in this treatment, but kept for consistency
    TERM_LENGTH = 3
    ...
    # Sets the probability of an "opposite of vote" outcome
    CHAOS_PROB = 0.40
...
class VoteWaitPage(WaitPage):
    ...
    def after_all_players_arrive(group: Group):
        ...
        if is_removed:
            ...
            # Increments the term counter if the rep is not removed
            session.vars['term_round'] += 1
...
class Stage2Decision(Page):
    ...
    def is_displayed(player: Player):
        ...
        # Finds if this player was removed
        ...
        # Shows page to any removed representative in this treatment
