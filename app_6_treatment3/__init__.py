...
doc = "Treatment 3: Lame-Duck (Term Limit). This app uses a self-contained rotation engine."
...
class VoteWaitPage(WaitPage):
    ...
    def after_all_players_arrive(group: Group):
        ...
        is_removed = False
        mechanism = ""
        # Checks if the representative was voted out
        if num_votes >= 2:
        ...
        if is_removed:
            ...
            # Implements the "Survivors Only" rule for Stage 2
            if mechanism == 'term_limit':
                # Stores information only for reps removed by term limit
...
class Stage2Decision(Page):
    ...
    def is_displayed(player: Player):
        ...
        # Finds if this player was a term-limit survivor
        ...
        # Shows page only to term-limit survivors
